...
public class Platform {
  ...
  public Platform(int x, int y, int w, int h, int type) {
    ...
    if (type == 1) {
      this.platformImageIcon = new ImageIcon(Platform.class.getResource("./assets/ground.png"));
      this.platformImage = this.platformImageIcon.getImage();
    } else {
      this.platformImageIcon = new ImageIcon(Platform.class.getResource("./assets/brick.png"));
      this.platformImage = this.platformImageIcon.getImage();
    } 
  }
  ...
  public void drawSelf(Graphics g) {
    ...
    g2d.drawImage(this.platformImage, (int)this.plat.getX(), (int)this.plat.getY(), (int)this.plat.getWidth(), (int)this.plat.getHeight(), null);
  }
  
  public void move(int speed) {
    this.plat.translate(speed, 0);
  }
}
